...
function createCastMovieElement(dataCastMovie) {
  ...
  castsElement.classList.add('cast-container container')
...
function createCrewMovieElement(dataCrewMovie) {
  ...
  crewsElement.classList.add('cast-container container')
